...
export default function IdCardBlack() {
  ...
  return (
    <motion.div
      className="group cursor-default text-xs font-oxanium rounded-3xl shadow-2xl overflow-hidden bg-[#e4e4e4] border-[#c9cccd] border-4 flex flex-col relative shadow-black"
      initial={false}
    >
      <motion.div
      ...
      >
        ...
        <section className='flex w-full h-1/4 group-hover:h-1/2 rounded-2xl transition-all duration-500 p-3 backdrop-blur rounded-t-0'>
          ...
          <p className='pointer-events-none cursor-default absolute text-black font-oxanium z-50 left-1/2 text-xl top-1/2 -translate-x-1/2 -translate-y-1/2 tracking-tight group-hover:-translate-y-3/4 group-hover:opacity-0 group-hover:duration-500 delay-300 group-hover:delay-0 transition-all'>learn more</p>
...
const ChatText = () => {
  const text = "Hi! I'm PCA-15, your new personal crisis assistant. Do you have any questions for me?";
